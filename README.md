...
💡 Bridging **research innovation** and **real-world engineering** — specializing in **adaptive machine learning frameworks**, **semi-supervised learning**, **Neural ODEs**, and **AI-driven automation**.
...
- **Semi-Supervised Learning** with adaptive uncertainty calibration and graph propagation
- **Neural ODEs & Wavelet Methods** for interpretable time-series and energy forecasting
- **Multi-Scale Attention Mechanisms** for heterogeneous datasets
- **Big Data-Driven Hybrid Models** for churn prediction with Explainable AI
- **NLP & Bangla Language Models** — fake news detection, fine-tuning, classification
- **RAG Pipelines** for intelligent document analysis and retrieval
- **AI Automation Frameworks** integrating testing, CI/CD, and validation

---

## 💼 Professional Experience

### **Data Engineer (Full-Time, Hybrid)**

**Eternity Labs**, Bangladesh | _Jun 2025 – Present_

- Developed scalable backend systems using **FastAPI** and automated data pipelines
- Implemented **Selenium** and **Playwright** testing frameworks for system validation
- Engineered data collection and real-time analytics solutions for production environments

### **Machine Learning & AI Consultant**

**Automation LAB**, Bangladesh | _Feb 2023 – Jun 2025_

- Designed and deployed **machine learning models** improving predictive accuracy across industries
- Led **AI project consultations**, guiding clients on data-driven decision-making
...
- **54 completed reviews** across 3 publications — ranked among prolific ML reviewers
- Contributing to scholarly rigor in machine learning, AI systems, and data science

---

## 🎓 Academic Background

- 🎓 **M.Sc. in Computer Science & Engineering** — _East Delta University_ (2022–2024) | CGPA: 3.83 / 4.00
- 🎓 **B.Sc. in Computer Science & Engineering** — _Port City International University_ (2016–2020) | CGPA: 3.86 / 4.00
...
- **[tts-model-project](https://github.com/joypciu/tts-model-project)**  
  Text-to-Speech model training and deployment pipeline.  
  _Tech:_ Python, Deep Learning, Audio Processing

- **[yolo_fastapi_deploy](https://github.com/joypciu/yolo_fastapi_deploy)**  
  Production-ready YOLO object detection API with FastAPI and containerized deployment.  
  _Tech:_ Python, YOLO, FastAPI, Docker
...
🎓 [View All Credentials →](https://joy-resume.vercel.app)
...
- Research collaboration in **semi-supervised learning, Neural ODEs, NLP, and applied ML**
- **Industry roles** in AI engineering, data engineering, or ML research
- Joint academic publications and peer-review activities
